                    ...
                    <div class="card"
                        ...
                        <div class="card-body">
                            <table class="table table-borderless mb-0" style="table-layout: auto; width: auto; ">
                                <tbody>
                                    <tr>
                                        <td style="white-space: nowrap;"><strong>Kelas</strong></td>
                                        <td>: {{ $schedule->class->name }}</td>
                                    </tr>
                                    <tr>
                                        <td style="white-space: nowrap;"><strong>SKS</strong></td>
                                        <td>: {{ $schedule->course->credit }}</td>
                                    </tr>
                                    <tr>
                                        <td style="white-space: nowrap;"><strong>Ruang Kelas</strong>
                                        </td>
                                        <td>: {{ $schedule->room->code }}</td>
                                    </tr>
                                    <tr>
                                        <td style="white-space: nowrap;"><strong>Kode Matkul</strong>
                                        </td>
