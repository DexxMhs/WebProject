        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <strong>Edit Gelar</strong>
                </div>
                <div class="card-body">
                    <form action="{{ route('dashboard.degree-levels.update', $degreeLevel) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        @include('dashboard.admin.degree-levels._form', ['degreeLevel' => $degreeLevel])
