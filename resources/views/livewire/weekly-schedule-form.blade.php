<div>
    <div class="mb-3">
        ...
        <select wire:model.lazy="form.class_id" name="class_id" id="class_id"
    ...
    <div class="mb-3">
        ...
        <select wire:model="form.course_id" name="course_id" id="course_id"
            class="form-control @error('course_id') is-invalid @enderror">
            <option value="">-- Select Course --</option>
            @foreach ($availableCourses as $item)
                <option value="{{ $item->id }}"
